...
class TicTacToe:
  ...
  def move_piece(self,player):
    ...
    new_row = int(input("Please enter the row number of the piece you would like to move: "))
    new_col = int(input("Please enter the column number of the piece you would like to move: "))
